        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 margin-b-60">
                    <div class="login-register-box row">
                    <form name="frmRegistro" id="frmRegistro" action="javascript:void(0);">
                      ...
                      <div class="form-group">
                          ...
                          <input id="confirmar_contrasena" name="confirmar_contrasena" type="password" class="form-control" placeholder="Confirmar contraseña">
                      </div><!--/form-group-->
                      </div>
                      <div class="col-sm-12">
                      <button type="submit" class="btn btn-lg btn-block btn-primary onRegistro">Guardar</button>
                      </div>
                      </form>
                    </div>
                    </div>
