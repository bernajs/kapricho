<?php
    ...
    if($servicios){
      foreach ($servicios as $servicio) {
        ...
        <a href="javascript:void(0)" class="onDelete" data-id="'.$id.'" data-src="servicio"><i class="ft-trash-2"></i></a>
        <a class="onEdit onModal" href="views/form.servicio.php?id='.$id.'"><i class="ft-edit"></i></a></td>';
      }
    }
?>
...
<div class="card">
  <div class="card-header">
    ...
    <a href="views/form.servicio.php" class="btn btn-outline-primary block btn-add onModal">Agregar servicio</a>
  </div>
